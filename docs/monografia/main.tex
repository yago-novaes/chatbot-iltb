...
\preambulo{Trabalho de Conclusão de Curso apresentado ao NOME DO CURSO
  da Universidade Federal do Espírito Santo como requisito parcial para
  obtenção do grau de Bacharel em NOME DO CURSO.}
...
\begin{folhadeaprovacao}
  \begin{center}
    ...
    \assinatura{\textbf{NOME DO MEMBRO 2} \\ INSTITUIÇÃO}
    \assinatura{\textbf{NOME DO MEMBRO 3} \\ INSTITUIÇÃO}
